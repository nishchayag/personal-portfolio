...
function About() {
  ...
  return (
    <div className="mt-20 mb-10">
      ...
      {/* Profile Section */}
      <div className="flex flex-col lg:flex-row items-center gap-12 mt-20 px-4 lg:px-20">
        {/* Profile Photo Placeholder */}
        <div className="flex-shrink-0">
          <div className="w-64 h-64 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full flex items-center justify-center shadow-2xl">
        ...
        {/* About Text */}
        <div className="flex-1 text-lg text-center lg:text-left">
          <span>
      ...
      <div className="mt-20 px-4 lg:px-20">
        <h2 className="text-4xl text-center mb-12">Let&apos;s Connect</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <a href="mailto:nishchay.agar@gmail.com" className="text-blue-600 hover:underline">
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <a href="tel:+919351325580" className="text-green-600 hover:underline">
                    +91 9351325580
                  </a>
                </div>
              </div>
